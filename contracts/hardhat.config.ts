...
const prodConfig = {
    ...
    SECURITY_COUNCIL_2_WEEKS_ADDRESS: process.env.MISC_SECURITY_COUNCIL_2_WEEKS_ADDRESS,
    SECURITY_COUNCIL_1_WEEK_ADDRESS: process.env.MISC_SECURITY_COUNCIL_1_WEEK_ADDRESS,
    SECURITY_COUNCIL_3_DAYS_ADDRESS: process.env.MISC_SECURITY_COUNCIL_3_DAYS_ADDRESS
};
const testnetConfig = {
    UPGRADE_NOTICE_PERIOD: 0,
    MAX_AMOUNT_OF_REGISTERED_TOKENS: 1023,
...
localConfig.SECURITY_COUNCIL_2_WEEKS_ADDRESS = process.env.MISC_SECURITY_COUNCIL_2_WEEKS_ADDRESS;
localConfig.SECURITY_COUNCIL_1_WEEK_ADDRESS = process.env.MISC_SECURITY_COUNCIL_1_WEEK_ADDRESS;
localConfig.SECURITY_COUNCIL_3_DAYS_ADDRESS = process.env.MISC_SECURITY_COUNCIL_3_DAYS_ADDRESS;
