...
describe("INTEGRATION", function() {
    ...
    it("ETH deposit, part exit, full exit, commit, verify, withdraw", async () => {
        ...
        commitment = "0xebea7f6ebc71aeb2febfbd750ec46f513d1e527c2bf5a98d7f65e3bbbb285dcb";
        ...
        commitment = "0xf8d56172b22427e926843b478edfb630bfdd45b6d7828cf1720ba0ace089947c";
        await postBlockCommit(
            provider,
            wallet,
            franklinDeployedContract,
    ...
    it("ERC20 deposit, part exit, full exit, commit, verify, withdraw", async () => {
        ...
        const value = parseEther("0.3"); // we send in tx value
