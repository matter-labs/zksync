...
describe("VERIFIER", function() {
    ...
    beforeEach(async () => {
        ...
        operatorsDeployedContract = await deployOperators(wallet, wallet.address, 60, operatorsTestContractCode);
    });
    ...
    it("Operators", async () => {
        ...
        let result = await operatorsDeployedContract.addOperator(
            wallet.address,
        ...
        let depositReceipt = await result.wait();
