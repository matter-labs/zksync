...
//         console.log("\n - Signers add started");
//         const blsVerifierDeployedContract = await deployBlsVerifier(wallet, wallet.address, 51, blsVerifierTestContractCode);

//         const result1 = await blsVerifierDeployedContract.addSigner(
//             signerAddress,
...
//         expect(await blsVerifierDeployedContract.signersCount()).equal(1);

//         const result2 = await blsVerifierDeployedContract.isSigner(signerAddress);
...
//         const result3 = await blsVerifierDeployedContract.changeMinSigsPercentage(60);
//         await result3.wait();

//         expect(await blsVerifierDeployedContract.minSigsPercentage()).equal(60);

//         console.log("\n + Changing min sigs percentage passed");
        
//         console.log("\n - Verifying message started");

//         const aggrPubKey = await blsVerifierDeployedContract.aggregatePubKeys(
//             [signerAddress]
//         );

//         const aggrSignature = await blsVerifierDeployedContract.aggregateSignatures(
//             [sigX, sigY], 1
//         );

//         // const h1 = await blsVerifierDeployedContract.messageToG11(
//         //     message
//         // );

//         // console.log(h1);

//         // const h2 = await blsVerifierDeployedContract.messageToG12(
//         //     message
//         // );

//         // console.log(h2);

//         const result4 = await blsVerifierDeployedContract.verify(
//             aggrSignature[0],
//             aggrSignature[1],
//             aggrPubKey[0],
//             aggrPubKey[1],
