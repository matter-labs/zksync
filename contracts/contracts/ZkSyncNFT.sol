 ...
 */
contract ZkSyncNFT is Context, ERC165, IERC721, IERC721Enumerable, NFTFactory {
    ...
    // Address of ZkSync contract for safety mining from L2
     ...
     *     bytes4(keccak256('contentHash(uint256)')) == 0xc87b56dd
     *
