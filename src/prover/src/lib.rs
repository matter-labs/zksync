...
impl BabyProver {
    ...
    pub fn apply_and_prove_transfer(&mut self, block: &Block, transactions: &Vec<TransferTx>) -> Result<FullBabyProof, Err> {
        ...
        for tx in transactions {
            let tx = plasma::models::circuit::TransferTx::try_from(tx).map_err(|e| BabyProverErr::InvalidTransaction(e.to_string()))?;
    ...
    pub fn apply_and_prove_deposit(&mut self, block: &Block, transactions: &Vec<DepositTx>) -> Result<FullBabyProof, Err> {
        ...
        for tx in transactions {
            let tx = plasma::models::circuit::DepositRequest::try_from(tx).map_err(|e| BabyProverErr::InvalidTransaction(e.to_string()))?;
    ...
    pub fn apply_and_prove_exit(&mut self, block: &Block, transactions: &Vec<ExitTx>) -> Result<FullBabyProof, Err> {
        ...
        for tx in transactions {
            let tx = plasma::models::circuit::ExitRequest::try_from(tx).map_err(|e| BabyProverErr::InvalidTransaction(e.to_string()))?;
