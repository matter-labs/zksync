...
pub struct EventsState {
    ...
    pub last_watched_eth_block_number: BlockNumber256,
}
...
impl EventsState {
    ...
    pub fn new() -> Self {
        Self {
            ...
            verified_blocks: vec![],
            last_watched_block_number: BlockNumber256::from(0),
        }
    }
    ...
    pub fn update_events_state(
        ...
        let (blocks, to_block_number): (ComAndVerBlocksVecs, BlockNumber256) = update_logs_and_last_watched_block(
        ...
        self.last_watched_eth_block_number = BlockNumber256::from(to_block_number.as_u64());
    }

    /// Return last watched ethereum block number
    pub fn get_last_block_number() -> Result<BlockNumber256, DataRestoreError> {
    ...
    fn update_logs_and_last_watched_block(
        last_watched_block_number: U256,
        eth_blocks_delta: U256,
        end_eth_blocks_delta: U256,
        ...
        let from_block_number_256 = last_watched_block_number + 1;
        let mut to_block_number_256 = 
        ...
        let logs = get_past_logs(from_block_number, to_block_number)?;
