    ...
    pub fn new(network: InfuraEndpoint) -> Self {
        ...
        match network {
            InfuraEndpoint::Mainnet => {
                Self {
                    web3_endpoint: "https://rinkeby.infura.io/".to_string(), //"https://rinkeby.infura.io/".to_string(),
                    franklin_contract: ethabi::Contract::load(PROD_PLASMA.0).unwrap(),
                    franklin_contract_address: "4fbf331db438c88a83b1316d072b7d73d8366367".parse().unwrap(), //"4fbf331db438c88a83b1316d072b7d73d8366367".parse().unwrap()
                }
            }
