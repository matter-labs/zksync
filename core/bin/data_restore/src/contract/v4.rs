...
fn decode_commitment_parameters(input_data: Vec<u8>) -> anyhow::Result<Vec<Token>> {
    ...
    let stored_block = ParamType::Tuple(vec![
        ParamType::Uint(32),       // uint32 _block_number
        ParamType::Uint(64),       // uint32 _number_of_processed_prior_ops
        ParamType::FixedBytes(32), // bytes32  processable_ops_hash
        ParamType::Uint(256),      // uint256 timestamp
        ParamType::FixedBytes(32), // bytes32 eth_encoded_root
