...
mod tests {
    ...
    async fn get_real_token_amount() {
        ...
        let dai_token = Token::new(TokenId(1), dai_token_address, "DAI", 18, true);
    ...
    async fn check_tokens() {
        ...
        let phnx_token = Token::new(TokenId(2), phnx_token_address, "PHNX", 18, true);

        let eth_address = Address::from_str("0000000000000000000000000000000000000000").unwrap();
        let eth_token = Token::new(TokenId(2), eth_address, "ETH", 18, true);
