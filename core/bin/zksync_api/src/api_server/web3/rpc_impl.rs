...
impl Web3RpcApp {
    pub async fn _impl_block_number(self) -> Result<U64> {
        ...
        metrics::histogram!("api", start.elapsed(), "type" => "web3", "endpoint" => "block_number");
    ...
    pub async fn _impl_get_balance(
        ...
        metrics::histogram!("api", start.elapsed(), "type" => "web3", "endpoint" => "get_balance");
        Ok(result)
    }
    ...
    pub async fn _impl_get_block_transaction_count_by_hash(
        ...
        metrics::histogram!("api", start.elapsed(), "type" => "web3", "endpoint" => "get_block_transaction_count_by_hash");
        Ok(result)
    }
    ...
    pub async fn _impl_get_block_transaction_count_by_number(
        ...
        metrics::histogram!("api", start.elapsed(), "type" => "web3", "endpoint" => "get_block_transaction_count_by_number");
        Ok(result)
    }
    ...
    pub async fn _impl_get_transaction_by_hash(self, hash: H256) -> Result<Option<Transaction>> {
        ...
        metrics::histogram!("api", start.elapsed(), "type" => "web3", "endpoint" => "get_transaction_by_hash");
        Ok(result)
    }
    ...
    pub async fn _impl_get_block_by_number(
        ...
        metrics::histogram!("api", start.elapsed(), "type" => "web3", "endpoint" => "get_block_by_number");
        Ok(result)
    }
    ...
    pub async fn _impl_get_block_by_hash(
        ...
        metrics::histogram!("api", start.elapsed(), "type" => "web3", "endpoint" => "get_block_by_hash");
        Ok(result)
    }
    ...
    pub async fn _impl_get_transaction_receipt(
        ...
        metrics::histogram!("api", start.elapsed(), "type" => "web3", "endpoint" => "get_transaction_receipt");
        Ok(result)
    }
    ...
    pub async fn _impl_get_logs(self, filter: Filter) -> Result<Vec<Log>> {
        ...
        metrics::histogram!("api", start.elapsed(), "type" => "web3", "endpoint" => "get_logs");
        Ok(result)
    }
    ...
    pub async fn _impl_call(self, req: CallRequest, _block: Option<BlockNumber>) -> Result<Bytes> {
        ...
        metrics::histogram!("api", start.elapsed(), "type" => "web3", "endpoint" => "call");
        result.map(Bytes)
    }
