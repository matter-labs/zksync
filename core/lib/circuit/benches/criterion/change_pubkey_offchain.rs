...
use zksync_types::ChangePubKeyOp;
...
/// Measures the time of changing pubkey offchain witness
fn change_pubkey_offchain_witness(b: &mut Bencher<'_>, number_of_accounts: &usize) {
...
pub fn bench_change_pubkey_offchain_witness(c: &mut Criterion) {
    c.bench_with_input(
        BenchmarkId::new("Change pubkey offchain witness", 1usize),
        &1usize,
