...
pub fn make_franklin_key() {
    ...
    let empty_operation = Operation {
        ...
        args: OperationArguments {
            ...
            amount_packed: None,
            full_amount: None,
            pub_signature_s: vec![None; franklin_constants::FR_BIT_WIDTH_PADDED],
            pub_signature_r_x: vec![None; franklin_constants::FR_BIT_WIDTH_PADDED],
            pub_signature_r_y: vec![None; franklin_constants::FR_BIT_WIDTH_PADDED],
            fee: None,
